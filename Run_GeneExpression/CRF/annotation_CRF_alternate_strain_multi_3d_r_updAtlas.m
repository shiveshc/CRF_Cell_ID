...
function annotation_CRF_alternate_strain_multi_3d_r_updAtlas(data,numLandmarks,numLabelRemove,rng_fix_landmark,num)
rng(rng_fix_landmark)
% %%% load image data and neuron relationship data (don't forget
% %%% landmark_names and landmark_to_neuron_map
% load(['C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_alternateStrains\AML5\RelPos\',data{1,18},'.mat'])
...
load(['/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/AlternateStrains/AML5/RelPos/',data,'.mat'])
load('/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/data_neuron_relationship_annotation_updated.mat')
...
% %%%% for data_20190809_29
% landmark_names = {'RMEL','RMED','RMEV','RMER'};
% landmark_to_neuron_map = [114;60;67;14];
...
%%%% dont forget to initialize dummy matrix
...
landmark_match_score = compare_labels_of_hidden_landmarks_r(curr_labels,marker_to_neuron_map,marker_name,landmark_names,Neuron_head);
...
%     node_pot =  ones(nNodes,nStates);
    ...
    landmarkMatchScore = compare_labels_of_hidden_landmarks_r(curr_labels,marker_to_neuron_map,marker_name,landmark_names,Neuron_head);
...
experiments_file = ['/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/AlternateStrains/AML5/RelPos/Results_numLand0/experiments_',data,'_',num2str(numLandmarks),'_',num2str(numLabelRemove),'_',num2str(rng_fix_landmark),'_',num2str(num),'.mat'];
