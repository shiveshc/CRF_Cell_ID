...
function annotation_CRF_neuropal_multi_3d_col_updAtlas_all(data,numLandmarks,numLabelRemove,rng_fix_landmark,num)
rng(rng_fix_landmark)
%%% load image data and neuron relationship data (don't forget
%%% landmark_names and landmark_to_neuron_map
% load(['C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\20190710_OH15495_array\27\',data,'.mat'])
...
experiments_file = ['/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/RelPos_Col/Results_updAtlas_all/experiments_',data,'_',num2str(numLandmarks),'_',num2str(numLabelRemove),'_',num2str(rng_fix_landmark),'_',num2str(num),'.mat'];
