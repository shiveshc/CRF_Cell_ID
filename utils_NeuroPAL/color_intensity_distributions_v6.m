...
%                 full_img(:,:,num_z_planes - j + 1,1) = imread([in_direc{1,i},'\',curr_name,'\',z_plane_names{j}]);
    ...
    thisimage_r_histmatch = imhistmatchn((thisimage_r_norm),src_thisimage_r_norm);
    thisimage_g_histmatch = imhistmatchn((thisimage_g_norm),src_thisimage_g_norm);
    thisimage_b_histmatch = imhistmatchn((thisimage_b_norm),src_thisimage_b_norm);
...
save('C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col\all_col_int_ex9_imadjust_colconsthistm','all_col_int')        