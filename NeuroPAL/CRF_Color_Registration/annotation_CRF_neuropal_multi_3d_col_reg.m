...
function annotation_CRF_neuropal_multi_3d_col_reg(data,numLandmarks,numLabelRemove,rng_fix_landmark,num)
rng(rng_fix_landmark)
%%% load image data and neuron relationship data (don't forget
%%% landmark_names and landmark_to_neuron_map
% load(['C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\20190710_OH15495_array\22\',data,'.mat'])
...
load(['/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/RelPos_Col_Reg/',data,'.mat'])
...
% load('C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\all_col_int')
load('/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/RelPos_Col_Reg/all_col_int')
node_pot_col = col_based_node_potential(all_col_int,data_int,Neuron_head);
addpath(genpath('/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/RelPos_Reg/CPD2'))
node_pot_reg = reg_based_node_potential(X,Y,Z,X_rot,Y_rot,Z_rot);
node_pot = node_pot_col + node_pot_reg;
...
experiments_file = ['/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/RelPos_Col_Reg/Results_multi_3D_numLand0_RGB/experiments_',data,'_',num2str(numLandmarks),'_',num2str(numLabelRemove),'_',num2str(rng_fix_landmark),'_',num2str(num),'.mat'];
