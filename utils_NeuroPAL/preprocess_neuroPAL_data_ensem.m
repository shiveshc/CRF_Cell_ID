...
%%% NOTE - pay attention to what color intensity data is being stored
%%% (normalized [0,1] or uint16) depending on what your atlas is
...
%%%%% for lateral orientation and ind_PCA = 1, marker neurons were used to
%%%%% correct axes. For rotated orientation and ind_PCA = 1,
%%%%% axes_neurons_to_neuron_map was used (although marker neurons could
%%%%% have been used)
