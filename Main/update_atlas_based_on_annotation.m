...
disp([num2str(size(uniq_annotated_neurons, 1)), ' unique neurons found in annotated data'])
...
disp('3. Calculating positional relationship features in annotated data')
...
disp('4. Updating OpenWorm atlas with features calculated from annotated data')
...
disp('5. Saving results')
DV_matrix = DV_matrix_data;
LR_matrix = LR_matrix_data;
PA_matrix = PA_matrix_data;
save('sample_run\data_neuron_relationship_annotation_updated','DV_matrix','eigval','eigvec','ganglion','geo_dist','LR_matrix','LR_neurons','LR_neurons_matrix','Neuron_head','PA_matrix','VC_neurons','X_rot','X_rot_norm','Y_rot','Z_rot','angle_vec_atlas')
