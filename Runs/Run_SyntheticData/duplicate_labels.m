function node_label = duplicate_labels_reg(curr_labels,X,Y,Z,PA_matrix,LR_matrix,DV_matrix,geo_dist,geo_dist_r,mu,Neuron_head,lambda_geo,clamped_neurons)
