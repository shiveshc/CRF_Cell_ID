...
function annotation_CRF_neuropal_multi_3d(data,numLandmarks,numLabelRemove,rng_fix_landmark,num)
...
load(['/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/',data,'.mat'])
...
experiments_file = ['/gpfs/pace1/project/pchbe2/schaudhary9/Annotation/NeuroPAL/Results_multi_3D/experiments_',data,'_',num2str(numLandmarks),'_',num2str(numLabelRemove),'_',num2str(rng_fix_landmark),'_',num2str(num),'.mat'];
