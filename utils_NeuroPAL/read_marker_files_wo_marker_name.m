%%%%%%% function to read marker file. This function is for reading marker
%%%%%%% file for neuropal worms that are rotated.
%%%%%% Inputs - 1. in_direc variable specifying folder path where 'marker'
%%%%%%             and 'marker_names.xlsx' are present. Specify it in
%%%%%%             terminal not in the code since this code is used in
%%%%%%             other codes as well.

function [X,Y,Z] = read_marker_files_wo_marker_name(in_direc)
