...
function score = consistency_score(i,i_label,node_label,X,Y,Z,PA_matrix,LR_matrix,DV_matrix,geo_dist,geo_dist_r,lambda_geo,node_pot)
    col_consistentcy_score = node_pot(i,i_label);
    ...
    score = (PA_consistency_score + LR_consistency_score + DV_consistency_score + geodist_consistency_score)/(4*max_consistency_score) + col_consistentcy_score;
end