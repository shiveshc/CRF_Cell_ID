function score = compare_labels_of_hidden_landmarks_r(curr_labels,marker_to_neuron_map,marker_name,landmarks,Neuron_head)

correct = 0;
cnt = 0;
for i = 1:size(marker_name,1)
        landmark_label = marker_name{i,1};
        assigned_label = Neuron_head{curr_labels(marker_to_neuron_map(i,1),1),1};
