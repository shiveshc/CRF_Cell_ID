...
%     addpath(genpath('C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\'))
    in_direc = {'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190706_5_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190706_21_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190710_2_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190710_5_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190710_8_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190710_10_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190710_22_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190710_24_numLand0\',...
        'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col_Reg\Results_leave_one_out\owatlas_ensem\Results_multi_3D_data_20190710_27_numLand0\'};
...
%     in_direc = {'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col\Results_leave_one_out\ensem_int_colconstnorm\run2\Results_multi_3D_data_20190710_10_numLand0\'};
%     
%     data = {'C:\Users\Shivesh\Dropbox (GaTech)\PhD\GlobalBrainCode\GlobalBrainTrackingNew\functions\Annotation_CRF\NeuroPAL_validation\prediction_NeuroPAL\RelPos_Col\data_20190710_10.mat'};
        ...
        for i = 1:size(fileList,1)
            ...
            if ~strcmp(name,'.') && ~strcmp(name,'..')
                ...
                for k = 1:size(landmark_to_be_pred,1)
                    if experiments(end).node_label(landmark_to_be_pred(k,1),1) == 0
                        labels{k,cnt} = '';
                    else
                        labels{k,cnt} = experiments(end).Neuron_head{experiments(end).node_label(landmark_to_be_pred(k,1),1),1};
                    end
                end
                cnt = cnt + 1;
            end
